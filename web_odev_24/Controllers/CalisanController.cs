...
namespace web_odev_24.Controllers
{
    public class CalisanController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("calisanID,calisan_ad,calisan_soyad")] Calisan calisan)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("calisanID,calisan_ad,calisan_soyad")] Calisan calisan)
        {
